...
class View extends CI_Controller {
	...
	public function listpengajuan()
	{
		if ( $this->logged)
		{
			// if($this->role == '10' || $this->role == '20' ){
				// $this->content['status_aduan'] = $this->input->get('par');
				$this->content['script'] = $this->data['base_url'].'assets/js/action/listpengajuan.js';
	...
	public function addpengajuan()
	{
		if ( $this->logged)
		{
			// if($this->role == '10' || $this->role == '20' ){
				// $this->content['status_aduan'] = $this->input->get('par');
				$this->content['script'] = $this->data['base_url'].'assets/js/action/addpengajuan.js';
	...
	public function listujilab()
	{
		if ( $this->logged)
		{
			// if($this->role == '10' || $this->role == '20' ){
				// $this->content['status_aduan'] = $this->input->get('par');
				$this->content['script'] = $this->data['base_url'].'assets/js/action/listujilab.js';
	...
	public function addlaporan()
	{
		if ( $this->logged)
		{
			// if($this->role == '10' || $this->role == '20' ){
				// $this->content['status_aduan'] = $this->input->get('par');
				$this->content['script'] = $this->data['base_url'].'assets/js/action/addlaporan.js';
